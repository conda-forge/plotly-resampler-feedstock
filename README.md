...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/plotly-resampler-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15026&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/plotly-resampler-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `plotly-resampler` can be installed with:

```
conda install plotly-resampler
```

It is possible to list all of the versions of `plotly-resampler` available on your platform with:
